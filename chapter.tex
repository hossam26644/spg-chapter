...
\texttt{PopulationConfiguration\ objects}, the \texttt{population\_size} parameter to
...
parameters in the \texttt{sim\_ancestry} function. The list of population
...
being allocated sequentially to the populations when \texttt{sim\_ancestry}
...
supplied to \texttt{sim\_ancestry} to turn on this feature.) Migration
