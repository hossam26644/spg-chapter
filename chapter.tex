...
\centering
\subfloat[][
The figure shows the full distribution of simulated values (violin plots) together with the observed and predicted means and their
confidence intervals across different sample sizes (n, shown on the x-axis). The confidence intervals are calculated as the
mean ± 1.96 × standard deviation. Observed means and simulated mean ± 1.96 × standard deviation are represented by orange circles
