...
and access to a diverse ecosystem of downstream 
>>>>>>> parent of 4b4c501 (Add line numbering)
...
\centering
\subfloat[][
The figure shows the full distribution of simulated values (violin plots) together with predicted means and
confidence intervals for different sample sizes (n, shown on the x-axis). The confidence intervals were calculated as the
mean ± 1.96 × standard deviation (dashed lines). Observed means and observed means ± 1.96 × standard deviation (from simulations) are represented by orange circles
...
\qquad\qquad
\subfloat[][
The full simulated and predicted distribution of total branch length (T\_total on the x-axis) for $n = 20$.
]{
...
\subfloat[][
    ...
    varying recombination rate (scaled recombination rate \textit{rho} on the x-axis), along with analytic predictions.]{
