...
values (violin plots) along with observed and predicted mean and
standard deviations for a range of sample sizes. Also shown are the observed means and standard
deviations from the simulations, as orange circles and green triangles,
respectively.
]{
